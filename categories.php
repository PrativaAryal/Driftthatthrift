...
<body>
    ...
    <?php
   $categoryidfrompreviuos=$_GET["category"];
        
    // Perform a database query to search for products based on the search query
    $sql = "SELECT p.* FROM `categories_products`as cp JOIN products as p ON p.category_id=cp.id  WHERE p.category_id=$categoryidfrompreviuos";
    ...
    ?>
        ...
        <h1 class="text-center title pt-5">No products of this category</h1>
        <?php
    }
    ?>
    </div>
